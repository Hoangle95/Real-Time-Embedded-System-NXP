...
*@Note:     Using The  gpio__construct_with_function() in "gpio.h"
            Only Supported:
========================================================================================================*/
void pin_configure_pwm_channel_as_io_pin(uint32_t port_num, uint32_t pin_num, gpio__function_e GPIO_FUNCTION) {
  gpio__construct_with_function(port_num, pin_num, GPIO_FUNCTION);
}
