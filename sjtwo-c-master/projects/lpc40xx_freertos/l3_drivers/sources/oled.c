...
//======================================================================================//
//                                OLED TRANSFER BYTE                                    //
// Goal : Transfer data to Data Register DR
...
//======================================================================================//
//                                PANEL INIT                                            //
// Goal : The sequence to set PANEL
...
//======================================================================================//
//                                CONTROL USAGE                                         //
//*@brief:  Data will print horizontal direction, Vertical, Page, Scrowling
//@Note:   Please Check The Datasheet of Sequence of Operation
//          * Require command_bus (ON)
//======================================================================================//
void horizontal_addr_mode() {
  ...
  oled__transfer_byte(0x00); // Horizontal
...
void page_addr_mode() {
  ...
  oled__transfer_byte(0xAF);

  oled__transfer_byte(0xB0);
